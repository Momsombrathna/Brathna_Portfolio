    ...
    return (
        ...
        <section className='mt-16'>
            ...
            <div className='flex flex-row bg-white px-2 py-1 rounded-lg items-center justify-center'>
                    <MdOutlinePsychology className='text-gray-800 text-2xl' />
                    <h1 className=' text-gray-800 text-xl pl-2 font-bold'>MY SKILLS</h1>
            </div>
            ...
            <div className='mt-10 flex lg:flex-row flex-col justify-center gap-12'>
                <div className='flex gap-3 flex-row justify-center'>
                    ...
                    <h1 className='text-xl text-white font-bold'>Programing&nbsp;Languages</h1>
                </div>
